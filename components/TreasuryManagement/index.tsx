        ...
        <FlexWrapper>
          ...
          <CircleContainer>
            <ContentWrapper>
              ...
              <p>
              Element is the perfect treasury diversification 
              solution allowing Protocols, DAOs and organizations
               to earn fixed rate yield on their treasury capital 
               while maintaining the ability to exit if needed.
